...
logo.setAttribute('company', 'banklist') //sets a new attribute to banklist
console.log(logo.getAttribute('src')); //gets url same as the one wrote in html

console.log(logo.dataset.versionNumber); //we get access to "data-version-number" by first using 'data-version-number'
